...
import { FailureWorkflowPanel } from "@/components/operations/FailureWorkflowPanel";
import { Separator } from "@/components/ui/separator";
import { MOCK_WORKSTATIONS } from "@/data/workstations";
import { cn } from "@/lib/utils";

const DigitalTwinScene = dynamic(
  () => import("@/components/twin/DigitalTwinScene").then((module) => module.DigitalTwinScene),
  { ssr: false },
);
