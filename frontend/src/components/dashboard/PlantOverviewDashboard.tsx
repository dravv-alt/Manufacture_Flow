...
function RecoverySuccessBanner() {
  ...
  return (
    <section
      data-story="recovered"
      className="mb-8 overflow-hidden rounded-[2rem] border border-emerald-500/30 bg-gradient-to-r from-emerald-950/90 via-[#192b21] to-[#12231a] p-6 text-white shadow-[0_24px_50px_rgba(4,120,87,0.15)] backdrop-blur"
    >
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="flex items-start gap-4">
          <div className="grid size-12 shrink-0 place-items-center rounded-2xl bg-emerald-400 text-emerald-950 shadow-md">
